    ...
    public partial class Init1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "TEXT", nullable: false),
                    Type_of_User = table.Column<int>(type: "INTEGER", nullable: false),
                    DeveloperProfileId = table.Column<Guid>(type: "TEXT", nullable: true),
                    RecruiterProfileId = table.Column<Guid>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_DeveloperProfiles_DeveloperProfileId",
                        column: x => x.DeveloperProfileId,
                        principalTable: "DeveloperProfiles",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AspNetUsers_RecruiterProfiles_RecruiterProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_DeveloperProfileId",
                table: "AspNetUsers",
